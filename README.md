...
> *A community for bug-phobic travelers to explore the world safely — without the creepy-crawlies!*

---

## 🚨 CRITICAL ALERT (October 2025)

**Iceland has 3 confirmed wild mosquitoes** (Smithsonian, Oct 2025). It remains *very* safe but is no longer an *absolute* zero-bug destination. For **guaranteed** zero-bug travel, choose **Antarctica, Svalbard, Faroe Islands, or Atacama** instead.
...
|----------|-----------------|
| 📂 `guides/` | Full destination guides (seasonal breakdowns, bug analysis, tips) |
| 📋 `DESTINATIONS.md` | Quick-reference list of all destinations with safest seasons |
| ⚠️ `SEASONAL_ALERTS.md` | Month-by-month bug risk heatmaps by region |
...
3. **Add** your destination guide using [SUBMISSION_TEMPLATE.md](SUBMISSION_TEMPLATE.md)
4. **Submit** a Pull Request — we review everything!

---

## 💬 Questions?

- Open a **GitHub Issue** — we read every one!
- Check our [FAQ](FAQ.md) first
- Share your bug-free travel stories!
