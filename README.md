...
2. **Planning a trip?** → Browse our [First Destination Research Guide](guides/1-first-destination-research.md)
3. **When to go?** → Check the [Seasonal Safety Calendar](guides/seasonal-safety-calendar.md)
4. **Want to contribute?** → Use the [Submission Template](guides/submission-template.md) and open a PR!
...
| 📖 [First Destination Research Guide](guides/1-first-destination-research.md) | 7 deep-dive destinations with verified sources |
...
*Built for every traveler who has ever swatted away a mosquito mid-vacation.* 🏜️✨
